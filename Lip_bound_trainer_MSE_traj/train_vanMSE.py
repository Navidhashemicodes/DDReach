...
def main():
    ...
    data = loadmat('Data_Main_traj_vanderpole')
    ...
    ##############################################
    initweights_file_path = 'C:/Users/navid/Documents/MATLAB/MATLAB_prev/others/Files/CDC2023/Conf_TNN_overall_ss_trajectory_TCPS_robust_TV/Test_cases/Submission/Vanderpole_MSE_quantile_comp/init_weights.mat'
    initbiases_file_path = 'C:/Users/navid/Documents/MATLAB/MATLAB_prev/others/Files/CDC2023/Conf_TNN_overall_ss_trajectory_TCPS_robust_TV/Test_cases/Submission/Vanderpole_MSE_quantile_comp/init_biases.mat'
    ...
    train_lip_bound(trainloader, net, 120, optimizer, epoch, verbose)


    export2matlab('Main_network_van_MSE',net)
