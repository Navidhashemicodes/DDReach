function [theInput, theOutput, maxmin] = nonlin_nln_Datagenerator_ss(lb, ub, normalization, num_traj , horizon, avg_m, cov_m, avg_s, cov_s) 
...
parfor j = 1:num_traj
    ...
    F(1:n,1) = initial+nu;
    for i=1:horizon
        in_out =  nonlinear(initial, avg_s, cov_s);
        index = n*i;
        nu = mvnrnd(avg_m , cov_m , 1 )';
