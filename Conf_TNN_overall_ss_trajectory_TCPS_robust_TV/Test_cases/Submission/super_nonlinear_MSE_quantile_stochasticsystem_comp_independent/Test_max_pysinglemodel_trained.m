...
load('Alpha_params_super_nonlinear_stochasticsystem.mat')
...
cd Results
save( 'super_nonlinear_result_addLP', 'Conf_overalls','Conformal_time', 'Star_sets', 'Reachability_time' , 'Lp_time', 'inv_Coefficients', 'maxim', 'A')
cd ..
