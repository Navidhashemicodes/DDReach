...
load('Main_network_super_nonlinear_stochasticsystem_MSE.mat')
...
cd Results
save( 'super_nonlinear_result_MSE_addLP', 'Conf_overalls','Conformal_time', 'Star_sets', 'Reachability_time' , 'inv_Coefficients', 'maxim', 'A')
cd ..