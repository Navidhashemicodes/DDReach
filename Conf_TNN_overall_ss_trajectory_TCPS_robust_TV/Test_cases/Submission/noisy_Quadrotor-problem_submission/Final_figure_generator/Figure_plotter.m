...
addpath(genpath('C:\Users\navid\Documents\MATLAB\MATLAB_prev\others\Files\CDC2023\Conf_TNN_overall_ss_trajectory_TCPS_robust_TV\Test_cases\Submission\noisy_Quadrotor-problem_submission'))
...
load('Quad_approx_Experiment3_4.mat')
...
Lb_shift_case = Lb; Ub_shift_case = Ub;
clear Lb Ub

%%%%%%%%%%%%%%%%%%%%%%%%%%%


load('Quad_approx_Experiment2.mat')
...
Lb_noshift_case = Lb; Ub_noshift_case  = Ub;
clear Lb Ub
...
ttt = tiledlayout(3, 4, 'TileSpacing', 'compact', 'Padding', 'compact');
...
for i = 1:n
    ...
    T2 = Out2(t*n+i, :);
    shaded_var_color(T2, 'blue')
    T3 = Out3(t*n+i, :);
    shaded_var_color(T3, 'red') 
    T1 = Out1(t*n+i, :);
    shaded_var_color(T1, 'green') 

    hold on;
    plot(t, Lb_noshift_case(i, :), '-red', 'LineWidth', 2);
    plot(t, Ub_noshift_case(i, :), '-red', 'LineWidth', 2);
    plot(t, Lb_shift_case(i, :)  , '-black'  , 'LineWidth', 2);
    plot(t, Ub_shift_case(i, :)  , '-black'  , 'LineWidth', 2);
