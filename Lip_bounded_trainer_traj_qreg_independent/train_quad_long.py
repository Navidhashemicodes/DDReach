...
def main():
    ...
    data = loadmat('Stochastic_train_quad_dataset_long2')
    ...
    Xtrain = data['X']
    Ytrain = data['Y']
    Xtrain = torch.Tensor(np.transpose(Ytrain[5388:5400,:]))
    # Xtrain = Xtrain.cuda()
    Ytrain = torch.Tensor(np.transpose(Ytrain[5400:6000,:]))
    # Ytrain = Ytrain.cuda()
    print(Xtrain.shape)
    print(Ytrain.shape)
    ...
    ##############################################
    # initweights_file_path = 'C:/Users/navid/Documents/MATLAB/MATLAB_prev/others/Files/CDC2023/Conf_TNN_overall_ss_trajectory_TCPS_robust_TV/Test_cases/Submission/noisy_Quadrotor-problem_submission_noshift_long/init_weights.mat'
    # initbiases_file_path = 'C:/Users/navid/Documents/MATLAB/MATLAB_prev/others/Files/CDC2023/Conf_TNN_overall_ss_trajectory_TCPS_robust_TV/Test_cases/Submission/noisy_Quadrotor-problem_submission_noshift_long/init_biases.mat'
    #
    ...
    export2matlab('Main_network_Quad_0_9_slong',net)
    ################################################
    ...
    scipy.io.savemat('init_alphas_0_9_slong.mat', {'alphas': weight_matrix0})
    ################################################
    ...
    penalty = 10
    q = 0.0001
    train_lip_bound(trainloader, net,  param2, 60, optimizer, epoch, verbose, delta, penalty, q)


    
    export2matlab('Main_network_Quad_stochasticsystem_9_slong',net)
    ...
    scipy.io.savemat('Alpha_params_Quad_stochasticsystem_9_slong.mat', {'alpha_values': weight_matrix})
