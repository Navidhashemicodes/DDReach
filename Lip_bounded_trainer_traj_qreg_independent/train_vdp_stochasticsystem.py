...
def main():
    ...
    data = loadmat('vdp_Data_traj_stochasticsystem')
    ...
    export2matlab('Main_network_vdp_stochasticsystem',net)
    ...
    scipy.io.savemat('Alpha_params_vdp_stochasticsystem.mat', {'alpha_values': weight_matrix})
