...
def main():
    ...
    export2matlab('Main_network_PT0',net)
    ################################################
    ...
    param2 = nn.Linear(1000,1, bias = False)
    ...
    penalty = 1000000
    q = 0.01
    train_lip_bound(trainloader, net,  param2, 400, optimizer, epoch, verbose, delta, penalty, q)


    
    export2matlab('Main_network_PT',net)
    ...
    scipy.io.savemat('Alpha_params_PT.mat', {'alpha_values': weight_matrix})
