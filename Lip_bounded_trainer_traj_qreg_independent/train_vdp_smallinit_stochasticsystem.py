...
def main():
    ...
    data = loadmat('vdp_small_Data_traj_stochasticsystem')
    
    
    
    Xtrain = data['X']
    Xtrain = torch.Tensor(np.transpose(Xtrain[:, :40000]))
    # Xtrain = Xtrain.cuda()
    Ytrain = data['Y']
    Ytrain = torch.Tensor(np.transpose(Ytrain[:, :40000]))
    # Ytrain = Ytrain.cuda()
    print(Xtrain.shape)
    print(Ytrain.shape)
    ...
    ##############################################
    # initweights_file_path = 'C:/Users/navid/Documents/MATLAB/MATLAB_prev/others/Files/CDC2023/Conf_TNN_overall_ss_trajectory_TCPS_robust_TV/Test_cases/Submission/Vanderpole_MSE_quantile_stochasticsystem_comp_independent/init_weights.mat'
    # initbiases_file_path = 'C:/Users/navid/Documents/MATLAB/MATLAB_prev/others/Files/CDC2023/Conf_TNN_overall_ss_trajectory_TCPS_robust_TV/Test_cases/Submission/Vanderpole_MSE_quantile_stochasticsystem_comp_independent/init_biases.mat'
    ...
    # initweights_file_path = 'C:/Users/navid/Documents/MATLAB/MATLAB_prev/others/Files/CDC2023/Conf_TNN_overall_ss_trajectory_TCPS_robust_TV/Test_cases/Submission/Vanderpole_MSE_quantile_stochasticsystem_comp_independent/init_alphas.mat'
    ...
    penalty = 1000000
    q = 0.001
    train_lip_bound(trainloader, net,  param2, 15000, optimizer, epoch, verbose, delta, penalty, q)

    
    export2matlab('Main_network_vdp_small_init_stochasticsystem',net)
    ...
    scipy.io.savemat('Alpha_params_vdp_small_init_stochasticsystem.mat', {'alpha_values': weight_matrix})
