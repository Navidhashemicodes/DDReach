...
def main():
    ...
    initweights_file_path = 'C:/Users/navid/Documents/MATLAB/MATLAB_prev/others/Files/CDC2023/Conf_TNN_overall_ss_trajectory_TCPS_robust_TV/Test_cases/Submission/super_nonlinear_MSE_quantile_noisy_comp_independent/init_alphas.mat'
    ...
    export2matlab('Main_network_super_nonlinear_noisy',net)
    ...
    scipy.io.savemat('Alpha_params_super_nonlinear_noisy.mat', {'alpha_values': weight_matrix})
